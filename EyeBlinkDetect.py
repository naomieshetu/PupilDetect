import numpy as np      # Will use this for pupil detection
...
def calculate_EAR(eye):                            # Calculate the eye aspect ratio
    ...
    # euclidean distance -> calculating the hypotenuse in a right triangle 
...
# Variables
blink_thresh = 0.35        # Threshold EAR value
